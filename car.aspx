...
<%
	...
	<div class="single">
		<div class="container">
			...
			<div class="agileits_three_comments">
				<h3><font face="微軟正黑體"color="#000000"><img src="images/clipboard.png" class="auto-style1" />點餐狀態</h3>

                <form id="form1" name="form1" method="post" action="car3.aspx">
     <table id="mt" width="80%" border="1" align="center">
  ...
  <thead>
   ...
   <td><%Response.Write(dr2["產品名稱"].ToString());   %> </td>
    <td class="style1"><%Response.Write(dr2["s_prod_num"].ToString());   %> </td>
     <td class="style2"><%Response.Write(dr2["價格"].ToString());
          // price +=  dr2["s_prod_num"].ToString   * dr2["價格"].ToString();
                        
           price2 = price2 + (int.Parse(dr2["價格"].ToString()) * int.Parse(dr2["s_prod_num"].ToString()));
                         %> </td>    
                          
<td><a href="del.aspx?id=<%Response.Write(dr2["s_id"].ToString());   %>">刪除</a></td>
 </tr>
           <%           
                    }
                }
  ...
  <input type="submit" name="Submit" value="送出餐點" />
      <input id="Button1" type="button"value="返回繼續點餐"onclick="location.href='prod.aspx?ps=主食'">
      <br />
			...
			<div class="agileinfo_footer_grids">
				...
				<div class="col-md-4 agileinfo_footer_grid">
					...
					<ul class="agileinfo_footer_grid_list">
						...
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>03 856 0309</li>					</ul>
				</div>
				<div class="col-md-4 agileinfo_footer_grid">
					<h3>快速連結</h3>
