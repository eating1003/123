...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string strsql;
        strsql = "delete from shop where s_id=" + Request["id"];
...
<body>
	...
	<div class="banner about-banner">
		...
		</div><body style="text-align: left">
    ...
    <div style="text-align: center">
        ...
        <br />
        <br />
        <h1><font face="微軟正黑體"color="#000000">刪除成功</h1><br />
        <br />
              <input id="Button1" type="button"value="返回繼續點餐"onclick="location.href='car.aspx'">
