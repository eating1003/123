	...
	<div class="single">
		<div class="container">
			...
			<div class="agileits_three_comments">
				<h3><b><span style="font-family:Microsoft JhengHei;"><font face="微軟正黑體"color="#000000"><img src="images/meeting.png" alt="" class="auto-style6"/> 您的桌號</span></b></h3>
...
<form id="form1" name="form1" method="post" action="order2.aspx">
 <table class="TB_COLLAPSE">
  <thead>
    <tr><th></th>
      ...
      <th></th>
                 ...
                 <tr>
    <td class="auto-style1">桌號</td>
    <td class="auto-style1">    <label>      <%
              if (Session["car"] == "")
              {
                  Response.Write(Request["table"]);
                  
              }
              else {
                  Response.Write(Session["table"]);
              }
               %>
      </label> 
  ...
  <tr>
    ...
    <td><label>
        <%
            if (Session["car"] == "")
            {
                ...
                Session["car"] = date1.ToString("yyyyMMddHHmmss");
            }
            else {
    ...
    <td><% Response.Write(Session["car"]); %></td>
    <td></td>
  </tr>
                <tr><td colspan="3" class="text-center"><label>
        &nbsp;可從上方餐點瀏覽裡選擇您想要吃的類別<a href="prod.aspx?ps=主食">或是點我開始瀏覽餐點 </a><br />
          或<a href="order.aspx?table=x">重新選位 </a>
      </label></td></tr>
</table>
</form>
