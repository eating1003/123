...
<%
  ...
  總金額:$<%Response.Write(price2);%>&nbsp;
      <input id="Button1" type="button" value="確定送出" onclick="location.href='car2.aspx'"><input id="Button2" type="button" value="我要繼續點" onclick="location.href='prod.aspx?ps=主食'"></center>
               
</form>
                <center>  <center><a href="Javascript:OnClick=history.back()">回上頁</a></center>
</center>
